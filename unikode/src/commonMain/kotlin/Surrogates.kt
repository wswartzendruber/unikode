...
public fun scalarValue(highSurrogate: Int, lowSurrogate: Int): Int =
    (((highSurrogate and 0x7FF) shl 10) or (lowSurrogate and 0x3FF)) or 0x10000
...
public fun Int.highSurrogate(): Char = (((this and 0xFFFF) ushr 10) or 0xD800).toChar()

public fun Int.lowSurrogate(): Char = (((this and 0xFFFF) and 0x3FF) or 0xDC00).toChar()
