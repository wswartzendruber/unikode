...
class Utf8EncoderTests {
    ...
    fun encode_string_single_chunk() {
        ...
        val testByteArray = ByteArray(textByteArrayUtf8.size)
        val encoder = Utf8Encoder()
        val byteCount = encoder.encode(TEXT, testByteArray)

        assertEquals(textByteArrayUtf8.size, byteCount)
        assertTrue(textByteArrayUtf8 contentEquals testByteArray)
    }
    ...
    fun encode_string_half_chunks() {
        ...
        assertEquals(textByteArrayUtf8.size, byteIndex)
        assertTrue(textByteArrayUtf8 contentEquals testByteArray)
    }
