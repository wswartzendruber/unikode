...
class Utf32LeEncoderTests {
    ...
    fun encode_string_single_chunk() {
        ...
        assertEquals(textByteArrayUtf32Le.size, byteCount)
        assertTrue(textByteArrayUtf32Le contentEquals testByteArray)
    }
    ...
    fun encode_string_half_chunks() {
        ...
        assertEquals(textByteArrayUtf32Le.size, byteIndex)
        assertTrue(textByteArrayUtf32Le contentEquals testByteArray)
    }
